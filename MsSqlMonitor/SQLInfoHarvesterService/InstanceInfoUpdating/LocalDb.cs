...
namespace SQLInfoCollectionService.InstanceInfoUpdating
{
    ...
    public class LocalDb : ILocalStorage
    {
        ...
        private void MapBaseInstanceDataToContext(InstanceInfo[] newInfo, MsSqlMonitorEntities context)
        {
        ...
        public async Task SaveInstancesAsync(InstanceInfo[] newInfo, ISLogger logger)
        {
            try
            {
                using (MsSqlMonitorEntities context = new MsSqlMonitorEntities())
        ...
        private void SetNewInstanceInfo(Tuple<Instance, InstanceInfo> linkedInfo)
        {
            ...
            if (instance.InstanceVersion == null) instance.InstanceVersion = new InstanceVersion();
            instance.InstanceVersion.Version = instInfo.Version;
